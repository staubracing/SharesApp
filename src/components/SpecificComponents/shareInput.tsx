...
export default function SharesComponent() {
  ...
  const createShareEntry = useCallback(
    (inputValue: string, description: string): Share => {
    ...
    <View>
      ...
      <View>
        <Text style={styles.whiteText}>
          {' '}
          Total of Staub's Shares: {totalShares}
        </Text>
      </View>

      <Button color="blue" title="Submit" onPress={addShare} />
    </View>
  );
}
